...
section{scroll-snap-align:center;height:100vh;display:flex;flex-direction:column;justify-content:center;padding:6vh 5vw;max-width:1320px;margin-inline:auto;overflow:hidden}
